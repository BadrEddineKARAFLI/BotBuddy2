...
# 25
SSP2ADD = (unsigned char)(-1 + (40000000L/(4*100000L)));
}
...
# 57
StartI2C2();
if (WriteI2C2(0x42) < 0) return -1;

if (WriteI2C2('C') < 0) return -1;
...
StartI2C2();
if (WriteI2C2(0x42) < 0) return (float)-1;

if (WriteI2C2('A') < 0) return (float)-1;

StopI2C2();

_delay((unsigned long)((10)*(40000000L/4000.0)));
...
if (WriteI2C2(0x43) < 0) return (float)-1;
resultH = ReadI2C2();
AckI2C2();
resultL = ReadI2C2();
NotAckI2C2();
...
# 134
StartI2C2();
if (WriteI2C2(0x42) < 0) return NULL;

if (WriteI2C2('A') < 0) return NULL;
...
if (WriteI2C2(0x43) < 0) return NULL;
heading[0] = ReadI2C2();
AckI2C2();
heading[1] = ReadI2C2();
NotAckI2C2();
