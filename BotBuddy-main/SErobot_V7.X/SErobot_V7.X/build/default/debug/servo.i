...
config = USART_TX_INT_OFF & USART_RX_INT_OFF & USART_EIGHT_BIT & USART_ASYNCH_MODE & USART_BRGH_LOW & USART_ADDEN_OFF;

# 26
spbrg = (unsigned int)(-1+(40000000L/(16L*(long)9600)));
