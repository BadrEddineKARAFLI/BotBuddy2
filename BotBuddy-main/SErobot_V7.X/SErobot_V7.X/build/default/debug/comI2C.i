...
if (numero_param == 0)
{
SSP1BUF = (unsigned char)(vBat >> 8);
numero_param = 1;
}
else
{
SSP1BUF = (unsigned char)(vBat);
numero_param = 0;
...
{
i2c_state = SSP1STAT & 0b00101101;


if ((i2c_state ^ 0b00001001) == 0)
tmp = SSP1BUF;


else if ((i2c_state ^ 0b00101001) == 0)
{
comI2C_cmd();
}


else if ((i2c_state ^ 0b00001101) == 0)
{
tmp = SSP1BUF;
comI2c_acqu();
}
...
else if (((i2c_state ^ 0b00101100) == 0) && (SSP1CON1bits.CKP == 0))
comI2c_acqu();



else if (((i2c_state ^ 0b00101100) == 0) && (SSP1CON1bits.CKP == 1))
