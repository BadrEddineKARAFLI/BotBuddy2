...
{LATDbits.LATD2 = 0;LATDbits.LATD3 = 0;};
LATBbits.LATB4 = 1;
_delay((unsigned long)((10)*(40000000L/4000000.0)));
LATBbits.LATB4 = 0;

while (flag_us == 0)
{
if (TMR1 >= (unsigned int)0xFF00)
{
us_lost=1;
us_distG = 100;
}
...
if (us_lost == 0) us_distG = (unsigned short)(1700.0f*(float)CCPR3/(float)(40000000L/32.0));
...
if (us_lost == 0) us_distC = (unsigned short)(1700.0f*(float)CCPR3/(float)(40000000L/32.0));
...
if (us_lost == 0) us_distD = (unsigned short)(1700.0f*(float)CCPR3/(float)(40000000L/32.0));
}
}
...
while (flag_us == 0)
if (TMR1 >= (unsigned int)0xFF00) us_lost=1;
...
break;
case 'C':
if (us_lost == 0) us_distC = (unsigned char)(1700.0f*(float)CCPR3/(float)(40000000L/32.0));
else us_distC = 100;

flag_us = 1;
break;
case 'D':
if (us_lost == 0) us_distD = (unsigned char)(1700.0f*(float)CCPR3/(float)(40000000L/32.0));
else us_distD = 100;
